 ...
 */
export declare const file_deps_google_api_http: GenFile;
 ...
 */
export declare const HttpSchema: GenMessage<Http, {jsonType: HttpJson}>;
 ...
 * @generated from message google.api.HttpRule
 */
export declare type HttpRuleJson = {
  /**
   * Selects a method to which this rule applies.
   *
   * Refer to [selector][google.api.DocumentationRule.selector] for syntax
 ...
 */
export declare const HttpRuleSchema: GenMessage<HttpRule, {jsonType: HttpRuleJson}>;
 ...
 * @generated from message google.api.CustomHttpPattern
 */
export declare type CustomHttpPatternJson = {
  /**
   * The name of this custom HTTP verb.
   *
   * @generated from field: string kind = 1;
 ...
 */
export declare const CustomHttpPatternSchema: GenMessage<CustomHttpPattern, {jsonType: CustomHttpPatternJson}>;
