...
describe('getRouteHandlers', () => {
  ...
  const mockLlmoController = {
    ...
    connectLlmoCloudFront: () => null,
    listLlmoCloudFrontDistributions: () => null,
    checkLlmoCloudFrontPrerequisites: () => null,
    fetchLlmoCloudFrontOrigins: () => null,
    fetchLlmoCloudFrontBehaviors: () => null,
    createLlmoCloudFrontOrigin: () => null,
    createLlmoCloudFrontRoutingFunction: () => null,
    applyLlmoCloudFrontCache: () => null,
    createLlmoCloudFrontLambda: () => null,
    fetchLlmoCloudFrontLambdaStatus: () => null,
    applyLlmoCloudFrontAssociations: () => null,
    verifyLlmoCloudFrontRouting: () => null,
    deployLlmoCloudFront: () => null,
    planLlmoCloudFront: () => null,
    getLlmoCloudFrontPermissions: () => null,
    getEdgeConfig: () => null,
  ...
  it('segregates static and dynamic routes', () => {
    ...
    const expectedDynamicRouteKeys = [
      ...
      'POST /sites/:siteId/llmo/onboarding/cloudfront/distributions',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/prerequisites',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/origins',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/behaviors',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/create-origin',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/create-function',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/apply-cache',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/create-lambda',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/lambda-status',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/apply-associations',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/verify',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/deploy',
      'POST /sites/:siteId/llmo/onboarding/cloudfront/plan',
