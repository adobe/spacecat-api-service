...
describe('getRouteHandlers', () => {
  ...
  it('segregates static and dynamic routes', () => {
    ...
    expect(dynamicRoutes['GET /sites/:siteId/opportunities/:opportunityId/suggestions/paged/:pageNum/:pageSize'].handler).to.equal(mockSuggestionsController.getAllForOpportunityPaged);
