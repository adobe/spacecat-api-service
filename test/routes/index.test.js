...
describe('getRouteHandlers', () => {
  ...
  it('segregates static and dynamic routes', () => {
    ...
    expect(dynamicRoutes).to.have.all.keys(
      ...
      'GET /v2/orgs/:imsOrgId/llmo-customer-config',
      'GET /v2/orgs/:imsOrgId/llmo-customer-config-lean',
      'GET /v2/orgs/:imsOrgId/llmo-topics',
      'GET /v2/orgs/:imsOrgId/llmo-prompts',
      'POST /v2/orgs/:imsOrgId/llmo-customer-config',
