...
describe('getRouteHandlers', () => {
  ...
  const mockLlmoMysticatController = {
    ...
    getMetadata: () => null,
    getStats: () => null,
    getSentimentOverview: () => null,
    getWeeklyTrends: () => null,
    getTopics: () => null,
    getTopicPrompts: () => null,
    getSearch: () => null,
    getShareOfVoice: () => null,
    getCompetitorTrends: () => null,
    getPrompts: () => null,
    getSources: () => null,
  };
  ...
  it('segregates static and dynamic routes', () => {
    ...
    expect(dynamicRoutes).to.have.all.keys(
      ...
      'GET /sites/:siteId/llmo/brand-presence/weeks',
      'GET /sites/:siteId/llmo/brand-presence/metadata',
      'GET /sites/:siteId/llmo/brand-presence/stats',
      'GET /sites/:siteId/llmo/brand-presence/sentiment-overview',
      'GET /sites/:siteId/llmo/brand-presence/weekly-trends',
      ...
      'GET /sites/:siteId/llmo/brand-presence/share-of-voice',
      'GET /sites/:siteId/llmo/brand-presence/competitor-trends',
      'GET /sites/:siteId/llmo/brand-presence/prompts',
      'GET /sites/:siteId/llmo/brand-presence/sources',
