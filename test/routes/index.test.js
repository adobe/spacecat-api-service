...
describe('getRouteHandlers', () => {
  ...
  const mockLlmoController = {
    ...
    getEdgeOptimizeDistributions: () => null,
    checkEdgeOptimizePrerequisites: () => null,
    getEdgeOptimizeOrigins: () => null,
    getEdgeOptimizeBehaviors: () => null,
    ...
    getEdgeOptimizeLambdaStatus: () => null,
    ...
    getEdgeOptimizeInstallerUrl: () => null,
    getEdgeConfig: () => null,
