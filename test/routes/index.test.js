...
describe('getRouteHandlers', () => {
  ...
  it('segregates static and dynamic routes', () => {
    ...
    expect(dynamicRoutes).to.have.all.keys(
      ...
      'GET /org/:spaceCatId/brands/all/brand-presence/execution-dates',
      'GET /org/:spaceCatId/brands/:brandId/brand-presence/execution-dates',
      'GET /org/:spaceCatId/brands/all/brand-presence/brand-vs-competitors',
      'GET /org/:spaceCatId/brands/:brandId/brand-presence/brand-vs-competitors',
