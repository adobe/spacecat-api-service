...
describe('getRouteHandlers', () => {
  ...
  it('segregates static and dynamic routes', () => {
    ...
    expect(dynamicRoutes).to.have.all.keys(
      ...
      'GET /sites/:siteId/llmo/sheet-data-download/:dataSource',
      'GET /sites/:siteId/llmo/sheet-data-download/:sheetType/:dataSource',
    ...
    expect(dynamicRoutes['GET /sites/:siteId/llmo/sheet-data-download/:dataSource'].handler).to.equal(mockLlmoController.getLlmoSheetDataDownload);
    expect(dynamicRoutes['GET /sites/:siteId/llmo/sheet-data-download/:dataSource'].paramNames).to.deep.equal(['siteId', 'dataSource']);
    expect(dynamicRoutes['GET /sites/:siteId/llmo/sheet-data-download/:sheetType/:dataSource'].handler).to.equal(mockLlmoController.getLlmoSheetDataDownload);
    expect(dynamicRoutes['GET /sites/:siteId/llmo/sheet-data-download/:sheetType/:dataSource'].paramNames).to.deep.equal(['siteId', 'sheetType', 'dataSource']);
