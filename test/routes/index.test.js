...
describe('getRouteHandlers', () => {
  ...
  const mockLlmoController = {
    ...
    connectEdgeOptimize: () => null,
    listEdgeOptimizeDistributions: () => null,
    checkEdgeOptimizePrerequisites: () => null,
    fetchEdgeOptimizeOrigins: () => null,
    fetchEdgeOptimizeBehaviors: () => null,
    createEdgeOptimizeOrigin: () => null,
    createEdgeOptimizeRoutingFunction: () => null,
    applyEdgeOptimizeCache: () => null,
    createEdgeOptimizeLambda: () => null,
    fetchEdgeOptimizeLambdaStatus: () => null,
    applyEdgeOptimizeAssociations: () => null,
    verifyEdgeOptimizeRouting: () => null,
    deployEdgeOptimize: () => null,
    planEdgeOptimize: () => null,
    getEdgeOptimizePermissions: () => null,
    getEdgeConfig: () => null,
