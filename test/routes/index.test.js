...
describe('getRouteHandlers', () => {
  ...
  it('segregates static and dynamic routes', () => {
    ...
    expect(dynamicRoutes['GET /sites/:siteId/llmo/athena'].handler).to.equal(mockLlmoController.getLlmoAthena);
    expect(dynamicRoutes['GET /sites/:siteId/llmo/athena'].paramNames).to.deep.equal(['siteId']);
