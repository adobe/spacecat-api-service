...
describe('Entity Controller', () => {
  ...
  describe('getLastUpdatedBy', () => {
    ...
    it('returns not found when entity does not exist', async () => {
      mockDataAccess.BaseModel.findById.resolves(null);
      ...
      expect(mockDataAccess.BaseModel.findById.calledWith(validUUID)).to.be.true;
    });

    it('returns not found when no update history exists', async () => {
      mockDataAccess.BaseModel.findById.resolves(mockEntity);
