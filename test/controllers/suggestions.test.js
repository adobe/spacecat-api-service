...
describe('Suggestions Controller', () => {
  ...
  describe('previewSuggestions (Tokowaka Preview)', () => {
    ...
    beforeEach(() => {
      ...
      s3ClientSendStub = sandbox.stub().callsFake(() => Promise.resolve());
      context.s3 = {
        s3Client: {
          send: s3ClientSendStub,
        },
    ...
    it('should preview headings suggestions successfully', async () => {
      ...
      // HTML might be null if fetch fails, but the properties should exist
    ...
    it('should handle missing and invalid status suggestions', async () => {
    ...
    it('should validate preview config structure uses preview path', async () => {
      const response = await suggestionsController.previewSuggestions({
        ...context,
        params: {
          siteId: SITE_ID,
