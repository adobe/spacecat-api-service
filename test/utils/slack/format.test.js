...
describe('Utility Functions', () => {
  ...
  describe('printSiteDetails()', () => {
    ...
    it('prints details for a site with audits disabled', () => {
      ...
      const expectedOutput = `:warning: LHS audit have been disabled for site or strategy! This is usually done when PSI audits experience errors due to the target having issues (e.g. DNS or 404).
