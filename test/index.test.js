...
describe('Index Tests', () => {
  ...
  it('handles options request', async () => {
    ...
    expect(resp.headers.plain()).to.eql({
      ...
      'access-control-allow-headers': 'x-api-key, authorization, origin, x-requested-with, content-type, accept, x-import-api-key, x-client-type, x-trigger-audits, x-view-as-trial, x-promise-token, x-trace-id',
