...
export const sentimentTopics = [
  {
    ...
    citations: [
      { url: 'https://en.wikipedia.org/wiki/Product_Quality', timesCited: 10, category: 'manufacturing' },
      { url: 'https://www.reddit.com/r/quality', timesCited: 5, category: 'reviews' },
    ],
    enabled: true,
  ...
  },
  {
    ...
    citations: [{ url: 'https://en.wikipedia.org/wiki/Pricing', timesCited: 3, category: 'pricing' }],
    enabled: false,
    createdBy: 'seed@test.com',
  },
];
