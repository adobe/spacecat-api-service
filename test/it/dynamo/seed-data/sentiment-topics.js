...
export const sentimentTopics = [
  {
    ...
    citations: [
      { url: 'https://en.wikipedia.org/wiki/Product_Quality', timesCited: 10 },
      { url: 'https://www.reddit.com/r/quality', timesCited: 5 },
    ],
    enabled: true,
  ...
  },
  {
    ...
    citations: [{ url: 'https://en.wikipedia.org/wiki/Pricing', timesCited: 3 }],
    enabled: false,
    createdBy: 'seed@test.com',
  },
];
