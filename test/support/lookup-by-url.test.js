...
describe('lookup-by-url support', () => {
  ...
  describe('parseLookupUrls', () => {
    ...
    it('drops entries containing a raw double-quote, backslash, or a control character (including DEL)', () => {
      ...
      const withDel = `https://e.com/c${String.fromCharCode(127)}d`;
      expect(mod.parseLookupUrls([
        'https://e.com/ok', 'https://e.com/a",")', withBackslash, withDel, 'https://e.com/b',
