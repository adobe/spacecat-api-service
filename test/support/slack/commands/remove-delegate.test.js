...
describe('RemoveDelegateCommand', () => {
  ...
  describe('handleExecution', () => {
    ...
    it('writes AccessGrantLog with REVOKE action before removing', async () => {
      await command.handleExecution(['https://example.com', IMS_ORG_ID, 'LLMO'], slackContext);
