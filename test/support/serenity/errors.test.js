...
describe('serenity error classification', () => {
  ...
  describe('ERROR_CODES', () => {
    it('exposes the serenity error tokens and is frozen', () => {
      ...
      expect(ERROR_CODES.SUBWORKSPACE_CREATION_FAILED).to.equal('subworkspaceCreationFailed');
      expect(ERROR_CODES.SUBWORKSPACE_CREATION_TIMEOUT).to.equal('subworkspaceCreationTimeout');
