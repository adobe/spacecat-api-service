...
const routeRequiredCapabilities = {
  ...
  // Email Traffic
  'GET /sites/:siteId/traffic/email/campaign': 'site:read',
  'GET /sites/:siteId/traffic/email/campaign/device': 'site:read',
  'GET /sites/:siteId/traffic/email/campaign/path': 'site:read',
  'GET /sites/:siteId/traffic/email/campaign/path/device': 'site:read',
  'GET /sites/:siteId/traffic/email/campaign/page-type': 'site:read',
  'GET /sites/:siteId/traffic/email/campaign/page-type/device': 'site:read',
  'GET /sites/:siteId/traffic/email/source': 'site:read',
  'GET /sites/:siteId/traffic/email/source/campaign': 'site:read',
  'GET /sites/:siteId/traffic/email/url': 'site:read',
  'GET /sites/:siteId/traffic/email/url/device': 'site:read',
  'GET /sites/:siteId/traffic/email/url/page-type': 'site:read',
  'GET /sites/:siteId/traffic/email/url/page-type/device': 'site:read',
  'GET /sites/:siteId/traffic/email/page-type': 'site:read',
  'GET /sites/:siteId/traffic/email/page-type/device': 'site:read',
  'GET /sites/:siteId/traffic/email/device': 'site:read',
  'GET /sites/:siteId/traffic/email/temporal/campaign': 'site:read',
  'GET /sites/:siteId/traffic/email/temporal/campaign/device': 'site:read',
  'GET /sites/:siteId/traffic/email/temporal/url': 'site:read',
  'GET /sites/:siteId/traffic/email/temporal/url/device': 'site:read',
  'GET /sites/:siteId/traffic/email/temporal/source': 'site:read',
  'GET /sites/:siteId/traffic/email/temporal/device': 'site:read',
  'GET /sites/:siteId/traffic/email/eca2/weekly-summary': 'site:read',
  'GET /sites/:siteId/opportunities/top-email': 'opportunity:read',
