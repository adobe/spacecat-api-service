...
const routeRequiredCapabilities = {
  ...
  // Elements/brand-presence routes accept either the existing per-org/per-brand
  // capability (organization:read / brand:read) or CAP_ORG_READ_ALL — an S2S
  // consumer holding organization:readAll gets a controller-level (Layer 2)
  // bypass of the org-membership check, so it must also clear the Layer 1 gate here.
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/url-inspector/filter-dimensions': ['organization:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/weeks': ['organization:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/access': ['organization:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/prompts': ['organization:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/url-inspector/cited-domains': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/sentiment-overview': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/responses': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/subreddits': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/reddit-threads': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/youtube-videos': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/topics': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/topics/:topicId/prompts': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/url-inspector/owned-urls': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/url-inspector/domain-urls': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/url-inspector/url-prompts': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/market-tracking-trends': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/stats': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/url-inspector/stats': ['brand:read', CAP_ORG_READ_ALL],
  // eslint-disable-next-line max-len
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/url-inspector/prompts/count': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/competitor-summary': ['brand:read', CAP_ORG_READ_ALL],
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/kpi-headlines': ['brand:read', CAP_ORG_READ_ALL],
  // eslint-disable-next-line max-len
  'GET /v2/orgs/:spaceCatId/brands/:brandId/serenity/brand-presence/source-visibility-headline': ['brand:read', CAP_ORG_READ_ALL],
