...
const routeRequiredCapabilities = {
  ...
  'GET /v2/orgs/:spaceCatId/brands/:brandId/semrush/prompts': 'organization:read',
  'POST /v2/orgs/:spaceCatId/brands/:brandId/semrush/prompts': 'organization:write',
  'PATCH /v2/orgs/:spaceCatId/brands/:brandId/semrush/prompts/:promptId': 'organization:write',
  'POST /v2/orgs/:spaceCatId/brands/:brandId/semrush/prompts/bulk-delete': 'organization:write',
  'GET /v2/orgs/:spaceCatId/brands/:brandId/semrush/projects': 'organization:read',
  'POST /v2/orgs/:spaceCatId/brands/:brandId/semrush/projects': 'organization:write',
  'GET /v2/orgs/:spaceCatId/brands/:brandId/semrush/projects/:workspaceId/:projectId/tags': 'organization:read',
  'GET /v2/orgs/:spaceCatId/brands/:brandId/semrush/projects/:workspaceId/:projectId/models': 'organization:read',
  'GET /v2/orgs/:spaceCatId/brands/:brandId/semrush/workspaces/:workspaceId/projects': 'organization:read',
