...
export default function getRouteHandlers(
  ...
  const routeDefinitions = {
    ...
    'GET /sites/:siteId/llmo/cache': llmoController.queryWithCache,
    'GET /sites/:siteId/llmo/cache/:dataSource': llmoController.queryWithCache,
    'GET /sites/:siteId/llmo/cache/:sheetType/:dataSource': llmoController.queryWithCache,
    'GET /sites/:siteId/llmo/cache/:sheetType/:week/:dataSource': llmoController.queryWithCache,
    'DELETE /sites/:siteId/llmo/cache': llmoController.clearCache,
