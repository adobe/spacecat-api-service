...
export default function getRouteHandlers(
  ...
  const routeDefinitions = {
    ...
    'POST /sites/:siteId/llmo/onboarding/cloudfront/bootstrap-url': llmoController.createLlmoCloudFrontBootstrapUrl,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/connect': llmoController.connectLlmoCloudFront,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/distributions': llmoController.listLlmoCloudFrontDistributions,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/prerequisites': llmoController.checkLlmoCloudFrontPrerequisites,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/origins': llmoController.fetchLlmoCloudFrontOrigins,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/behaviors': llmoController.fetchLlmoCloudFrontBehaviors,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/create-origin': llmoController.createLlmoCloudFrontOrigin,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/create-function': llmoController.createLlmoCloudFrontRoutingFunction,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/apply-cache': llmoController.applyLlmoCloudFrontCache,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/create-lambda': llmoController.createLlmoCloudFrontLambda,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/lambda-status': llmoController.fetchLlmoCloudFrontLambdaStatus,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/apply-associations': llmoController.applyLlmoCloudFrontAssociations,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/verify': llmoController.verifyLlmoCloudFrontRouting,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/deploy': llmoController.deployLlmoCloudFront,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/plan': llmoController.planLlmoCloudFront,
    'GET /sites/:siteId/llmo/onboarding/cloudfront/permissions': llmoController.getLlmoCloudFrontPermissions,
    ...
    'POST /sites/:siteId/agentic-traffic/hits-by-urls': llmoMysticatController.getAgenticTrafficHitsByUrls,
