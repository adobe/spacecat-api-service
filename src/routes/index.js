...
export default function getRouteHandlers(
  ...
  const routeDefinitions = {
    ...
    'POST /sites/:siteId/llmo/edge-optimize/prerequisites': llmoController.checkEdgeOptimizePrerequisites,
    'POST /sites/:siteId/llmo/edge-optimize/origins': llmoController.getEdgeOptimizeOrigins,
    'POST /sites/:siteId/llmo/edge-optimize/behaviors': llmoController.getEdgeOptimizeBehaviors,
    'POST /sites/:siteId/llmo/edge-optimize/create-origin': llmoController.createEdgeOptimizeOrigin,
