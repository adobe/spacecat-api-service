...
export default function getRouteHandlers(
  ...
  const routeDefinitions = {
    ...
    'POST /sites/:siteId/llmo/onboarding/cloudfront/bootstrap-url': llmoController.createEdgeOptimizeBootstrapUrl,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/connect': llmoController.connectEdgeOptimize,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/distributions': llmoController.listEdgeOptimizeDistributions,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/prerequisites': llmoController.checkEdgeOptimizePrerequisites,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/origins': llmoController.fetchEdgeOptimizeOrigins,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/behaviors': llmoController.fetchEdgeOptimizeBehaviors,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/create-origin': llmoController.createEdgeOptimizeOrigin,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/create-function': llmoController.createEdgeOptimizeRoutingFunction,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/apply-cache': llmoController.applyEdgeOptimizeCache,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/create-lambda': llmoController.createEdgeOptimizeLambda,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/lambda-status': llmoController.fetchEdgeOptimizeLambdaStatus,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/apply-associations': llmoController.applyEdgeOptimizeAssociations,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/verify': llmoController.verifyEdgeOptimizeRouting,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/deploy': llmoController.deployEdgeOptimize,
    'POST /sites/:siteId/llmo/onboarding/cloudfront/plan': llmoController.planEdgeOptimize,
    'GET /sites/:siteId/llmo/onboarding/cloudfront/permissions': llmoController.getEdgeOptimizePermissions,
