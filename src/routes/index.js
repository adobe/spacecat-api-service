...
export default function getRouteHandlers(
  ...
  const routeDefinitions = {
    ...
    'OPTIONS /sites/:siteId/llmo/brand-presence/filters': llmoController.handleBrandPresenceOptions,
    'GET /sites/:siteId/llmo/brand-presence/sentiment-overview': llmoController.getSentimentOverview,
    'OPTIONS /sites/:siteId/llmo/brand-presence/sentiment-overview': llmoController.handleBrandPresenceOptions,
    'GET /sites/:siteId/llmo/brand-presence/stats': llmoController.getBrandPresenceStats,
    'OPTIONS /sites/:siteId/llmo/brand-presence/stats': llmoController.handleBrandPresenceOptions,
    'GET /sites/:siteId/llmo/brand-presence/competitor-comparison': llmoController.getCompetitorComparison,
    'OPTIONS /sites/:siteId/llmo/brand-presence/competitor-comparison': llmoController.handleBrandPresenceOptions,
    ...
    'OPTIONS /sites/:siteId/llmo/brand-presence/topics': llmoController.handleBrandPresenceOptions,
    'GET /sites/:siteId/llmo/brand-presence/topics/:topic/prompts': llmoController.getBrandPresencePrompts,
    'OPTIONS /sites/:siteId/llmo/brand-presence/topics/:topic/prompts': llmoController.handleBrandPresenceOptions,
    'GET /sites/:siteId/llmo/brand-presence/search': llmoController.searchBrandPresence,
    'OPTIONS /sites/:siteId/llmo/brand-presence/search': llmoController.handleBrandPresenceOptions,
