...
import LlmoUrlInspectorController from './controllers/llmo/llmo-url-inspector-controller.js';
...
async function run(request, context) {
  ...
  try {
    ...
    const llmoUrlInspectorController = LlmoUrlInspectorController(context);
