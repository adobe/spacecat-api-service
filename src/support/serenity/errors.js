...
export const ERROR_CODES = Object.freeze({
  ...
  TAG_TREE_LIMIT_EXCEEDED: 'tagTreeLimitExceeded',
  TAG_TREE_DATA_INTEGRITY: 'tagTreeDataIntegrity',
  TAG_SEARCH_CURSOR_INVALID: 'tagSearchCursorInvalid',
  TAG_SEARCH_SNAPSHOT_CHANGED: 'tagSearchSnapshotChanged',
  TAG_SEARCH_UNAVAILABLE: 'tagSearchUnavailable',
