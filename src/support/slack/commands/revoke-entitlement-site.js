...
const PHRASES = ['revoke entitlement site'];

/**
 * A factory function that creates an instance of the RevokeEntitlementSiteCommand.
 *
 * @param {object} context - The context object.
 * @returns {RevokeEntitlementSiteCommand} An instance of the command.
 * @constructor
 */
function RevokeEntitlementSiteCommand(context) {
  const baseCommand = BaseCommand({
    id: 'revoke-entitlement-site',
    name: 'Revoke Entitlement for Site',
  ...
  /**
   * Executes the command to revoke entitlement for a site.
   *
...
export default RevokeEntitlementSiteCommand;
