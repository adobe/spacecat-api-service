...
const PHRASES = ['revoke entitlement imsorg'];

/**
 * A factory function that creates an instance of the RevokeEntitlementImsOrgCommand.
 *
 * @param {object} context - The context object.
 * @returns {RevokeEntitlementImsOrgCommand} An instance of the command.
 * @constructor
 */
function RevokeEntitlementImsOrgCommand(context) {
  const baseCommand = BaseCommand({
    id: 'revoke-entitlement-imsorg',
    name: 'Revoke Entitlement for IMS Org',
  ...
  /**
   * Executes the command to revoke entitlement for an IMS org.
   *
...
export default RevokeEntitlementImsOrgCommand;
