...
export function getLastTwoCompleteWeeks() {
  ...
  // Last complete week's end: next Monday at 00:00:00.000 UTC (7 days after start)
  const lastMondayEnd = new Date(Date.UTC(
  ...
  // Week before that - end: next Monday at 00:00:00.000 UTC
  const prevMondayEnd = new Date(Date.UTC(
  ...
  return [
    {
      label: getStringDate(lastMondayEnd),
      startTime: lastMonday.toISOString(),
      endTime: lastMondayEnd.toISOString(),
    },
    {
      label: getStringDate(prevMondayEnd),
      startTime: prevMonday.toISOString(),
      endTime: prevMondayEnd.toISOString(),
    },
  ];
}
