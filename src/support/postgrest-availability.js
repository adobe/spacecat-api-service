 ...
 *
 * Introduced for the FACS state-layer management endpoints
 * (`support/state-access-mapping-utils.js`). The `requirePostgrestForV2Config`
 * alias below mirrors the private guard currently inlined in
 * `controllers/brands.js` (20+ call sites) and is ready for that controller to
 * adopt in a follow-up, so the check can live in one place.
 *
