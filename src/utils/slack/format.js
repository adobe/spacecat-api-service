...
const printSiteDetails = (site, isAuditEnabled, psiStrategy = 'mobile', latestAudit = null) => {
  ...
  const auditDisabledText = !isAuditEnabled ? ':warning: LHS audit have been disabled for site or strategy! This is usually done when PSI audits experience errors due to the target having issues (e.g. DNS or 404).\n' : '';
