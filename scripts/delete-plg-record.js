...
/**
 * Delete PLG Onboarding Record
 *
 * Usage:
 *   node scripts/delete-plg-record.js <imsOrgId> <domain>
 *
 * Example:
 *   node scripts/delete-plg-record.js ABC123@AdobeOrg example.com
 *
...
async function main() {
  ...
  if (!imsOrgId || !domain) {
    console.error('Usage: node scripts/delete-plg-record.js <imsOrgId> <domain>'); // eslint-disable-line no-console
    process.exit(1);
  }
